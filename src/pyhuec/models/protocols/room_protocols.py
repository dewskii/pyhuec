...
class RoomServiceProtocol(Protocol):
    ...
    async def create_room(
        self, name: str, archetype: str, children: List[ResourceIdentifierDTO]
    ) -> str:
        """
    ...
    async def add_light_to_room(self, room_id: str, light_id: str) -> bool:
        """
    ...
    async def remove_light_from_room(self, room_id: str, light_id: str) -> bool:
        """
    ...
    async def get_room_lights(self, room_id: str) -> List[ResourceIdentifierDTO]:
        """
