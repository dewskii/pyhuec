...
from pyhuec.models.dto.light_dto import LightIdentifyDTO, LightListResponseDTO, LightResponseDTO, LightUpdateDTO, LightUpdateResponseDTO
from pyhuec.models.protocols.light_protocol import LightRepositoryProtocol
