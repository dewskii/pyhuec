...
from pyhuec.models.dto import SceneResponseDTO
from pyhuec.models.protocols import SceneServiceProtocol
...
class SceneService(SceneServiceProtocol):
    ...
    async def activate_scene(
        self, scene_id: str, duration: Optional[int] = None
    ) -> bool:
        """
        Activate a scene.
    ...
    async def update_scene_actions(self, scene_id: str, actions: List[dict]) -> bool:
        """
